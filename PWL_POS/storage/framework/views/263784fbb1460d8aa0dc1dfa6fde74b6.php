  ...
  <div class="register-box">
    <div class="card card-outline card-primary">
      ...
      <div class="card-body">
        ...
        <form action="<?php echo e(route('signUp.storeMember')); ?>" method="post" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
          <div class="input-group mb-3">
            <input type="text" class="form-control" placeholder="Full name" name="nama" value="<?php echo e(old('nama')); ?>">
        ...
        <div class="mb-0 mt-2 text-center">
          <a href="<?php echo e(route('signIn.index')); ?>" class="text-center">I already have a membership</a>
        </div>
      </div>
      <!-- /.form-box -->
    </div><!-- /.card -->
...
</html><?php /**PATH D:\laragon\www\PWL2024\PWL_POS\resources\views/auth/signUp.blade.php ENDPATH**/ ?>